  ...
  return (
    <section className="rounded-3xl border border-black/10 bg-white p-7">
      ...
      <div className="mt-6 overflow-hidden border border-black/10 bg-white">
        <div className="grid gap-0 grid-cols-2 auto-rows-[120px] sm:grid-cols-12 md:auto-rows-[160px]">
          <div className="col-span-1 row-span-2 sm:col-span-4 sm:row-span-4">
          ...
          <div className="col-span-1 row-span-1 sm:col-span-4 sm:row-span-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
