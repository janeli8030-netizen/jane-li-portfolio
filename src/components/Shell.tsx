...
export default function Shell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh bg-[var(--bg)] text-[var(--ink)]">
      <header className="sticky top-0 z-50 border-b border-black/5 bg-[rgba(255,255,255,0.82)] text-black shadow-[0_10px_24px_rgba(15,23,42,0.04)] backdrop-blur-2xl supports-[backdrop-filter]:bg-[rgba(255,255,255,0.72)]">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-white/95" />
        <div className="pointer-events-none absolute inset-x-[10%] top-0 h-12 bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(255,255,255,0))] blur-xl" />
